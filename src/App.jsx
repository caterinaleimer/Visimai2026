...
const speakers = [
  ...
  },
  {
    ...
    abstract:
      "Traditional football commentary has historically focused on describing events occurring on the pitch. However, during the FIFA World Cup 2026, Lele Adani introduced a disruptive broadcasting paradigm demonstrating that RAI 1 could overcome the historical dominance of Canale 5 in trash-content peaks, introducing a new benchmark for high-impact television entertainment. In this work, we present the VISI-SHIT framework, a computational methodology combining signal processing, natural language processing and machine learning to quantify the benefits of this emerging commentary style. We introduce novel quantitative metrics including the Garra Index, Fútbol Semantic Density, Dios Invocation Frequency, and Shouting-to-Foul Ratio.",
  },
];
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-display selection:bg-primary selection:text-white">
      ...
      <nav className="sticky top-0 z-50 w-full bg-background/85 backdrop-blur-md border-b border-border">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-8 text-[11px] font-mono uppercase tracking-widest">
            ...
            <a href="#sosta" className="transition-colors hover:text-primary">
              SOSTA Break
            </a>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-12 gap-10 lg:gap-14 items-stretch">
          {/* Testo a sinistra */}
          <div className="col-span-12 lg:col-span-7 flex flex-col justify-center">
            <p className="font-mono text-sm uppercase tracking-[0.22em] text-[#C7654E] mb-5">
              Second event of the day
            </p>

            <h2 className="font-mono text-3xl md:text-4xl uppercase tracking-[0.12em] text-[#557C78] leading-tight">
              02 // SOSTA Break
            </h2>

            <div className="w-16 h-px bg-[#C7654E] my-7" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-9">
              <div className="bg-[#FAF8F3] border border-[#D8CFC2] rounded-2xl p-6">
                <p className="font-mono text-xs uppercase tracking-[0.18em] text-[#C7654E]">
                  Location
                </p>
              ...
              <div className="bg-[#FAF8F3] border border-[#D8CFC2] rounded-2xl p-6">
                ...
                <p className="text-lg font-bold mt-3">From 18:00</p>

                <p className="text-sm md:text-base text-muted-foreground mt-1">
                  Farewell coffee and poster session
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-12 lg:col-span-5">
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#252933]/80 to-transparent p-7 pt-24">
                <p className="font-mono text-xs uppercase tracking-[0.2em] text-[#F4F0E8]/75">
                  Farewell coffee
                </p>

                <p className="text-2xl font-bold text-white mt-2">
                  In honour of Luca Sosta
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-white/15 rounded-2xl p-8 md:p-10 bg-white/5">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-[280px_1fr]">
              <div className="p-6 md:p-8 bg-[#E8EEE9]">
                ...
                <p className="font-mono text-sm text-[#C7654E] uppercase tracking-[0.18em] mt-6">
                  {selectedSpeaker.role}
                </p>

                <p className="font-mono text-sm text-muted-foreground uppercase tracking-[0.18em] mt-3">
