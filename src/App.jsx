...
import coauthor2 from "./assets/alessandra-cancrini.jpeg";
...
const keynoteSpeaker = {
  ...
  abstract: "Keynote abstract to be announced.",
};
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex flex-col justify-end pb-20">
          <div className="overflow-hidden mb-6">
            <img
              src={conferenceLogo}
              alt="VISIMAI 2026 conference logo"
              className="
                hero-block hero-delay-1
                w-28 h-28
                md:w-36 md:h-36
                object-cover
                rounded-2xl
          ...
          <div className="overflow-hidden">
            <p className="hero-block hero-delay-2 font-mono text-[18px] md:text-[22px] uppercase tracking-[0.3em] mb-4 text-[#B55440]">
              May 12–14, 2026
            </p>
          </div>

          <div className="overflow-hidden">
            <h1 className="hero-block hero-delay-3 text-6xl md:text-8xl font-extrabold tracking-tighter leading-[0.9]">
              VISIMAI 2026
            </h1>
          </div>

          <div className="overflow-hidden">
            <p className="hero-block hero-delay-4 max-w-3xl text-xl md:text-2xl font-bold mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 items-start">
            {speakers.map((speaker) => (
              ...
              >
                <div className="relative aspect-[3/2] overflow-hidden bg-[#DDE5E0]">
                  {speaker.coauthorImage ? (
                    <div className="grid grid-cols-2 w-full h-full">
                      <div className="relative overflow-hidden border-r-4 border-[#C7654E]">
                        <img
                          src={speaker.image}
                          alt={speaker.name}
                          className="
                ...
                <div className="p-5">
                  <span className="font-mono text-xs text-[#C7654E] uppercase tracking-[0.14em]">
                    {speaker.role}
                  </span>

                  <p className="font-mono text-xs text-muted-foreground uppercase tracking-[0.14em] mt-2">
                    {speaker.affiliation}
                  </p>
                  ...
                  <p className="font-mono text-[10px] uppercase tracking-widest text-[#557C78] mt-5">
                    View abstract →
                  </p>
                </div>
              </button>
